...
export default function StatsCard(props: Props) {
  ...
  return (
    <div
      className="bg-card-background border p-6 col-span-6 md:col-span-3 lg:col-span-2 flex flex-col gap-2 hover:-translate-y-1 hover:border-accent-neon rounded-lg w-full text-center text-muted uppercase hover:shadow-card-hover"
      ref={cardRef}
